...
public class OkHttpUtil {
    ...
    public static void main(String[] args) {
        try {
            String url = "https://firebasedynamiclinks.googleapis.com/v1/shortLinks?key=AIzaSyA4dBqhbl2qDoc1dq9nYFxl1AoucjRHWUc";
            String jsonObj = postJson(url,"{\"dynamicLinkInfo\": {\"domainUriPrefix\": \"https://rtytest.page.link\",\"link\": \"https://www.example.com/\"}}");
            JSONObject obj = JSONObject.parseObject(jsonObj);
            System.out.println(obj.get("shortLink"));
