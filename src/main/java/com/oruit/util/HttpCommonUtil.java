...
public class HttpCommonUtil {
    ...
    public static void main(String[] args) {
        /*
         * String s =
         * "<div> <span>*发团前：</span> <div> 小时收取 %的交易金额，作为手续费。 </div> </div><br>嘎嘎嘎嘎嘎"
         * ; System.out.println(getLimitHtmlString(s, 100));
         */

        System.out.println(HttpCommonUtil.isInteger("sss"));
    }
    ...
    public static class CustomBeanUtils extends BeanUtils {
        ...
        public static List<Map<String, Object>> transBean2MapListContain(List list, String[] containProperties) {
            if (HttpCommonUtil.isEmptyList(list)) {
                return null;
            }
         ...
         */
        /*
         * public static Map<String, Object> transBean2ListMap(List<Object>
         * objList) { if (obj == null) { return null; } Map<String, Object> map
         * = new HashMap<String, Object>(); try { BeanInfo beanInfo =
         * Introspector.getBeanInfo(obj.getClass()); PropertyDescriptor[]
         * propertyDescriptors = beanInfo.getPropertyDescriptors(); for
         * (PropertyDescriptor property : propertyDescriptors) { String key =
         * property.getName(); // 过滤class属性 if (!key.equals("class")) { //
         * 得到property对应的getter方法 Method getter = property.getReadMethod();
         * Object value = getter.invoke(obj); map.put(key, value); } } } catch
